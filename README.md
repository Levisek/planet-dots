...
- **V4.3** (plán): Realismus orbit a tvarů — Kepler pro planety (eccentricity), inclination pro vše, suplementární clamp logika, sjednocení retrograde mechaniky. Nové měsíce: Hyperion (chaotic tumbling), Phoebe, Sinope, Pasiphae. Non-uniform tvary nepravidelných moonů. Texture completion (real → komunitní → procedural mirror+blur) + edu „nenafoceno" tooltip. Speed slider 0.1×–5× v dolním HUD + simulační datum (J2000.0). Asteroid teaser (Ceres/Vesta/Pallas + 300-particle ring). Moon orbit lines v detail view. Saturn ring tilt verifikace. Spec: `docs/superpowers/specs/2026-05-05-dots-v4.3-realismus-design.md`.

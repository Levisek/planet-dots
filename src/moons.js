...
// tickCount = 10242 (icosphere level 5) pro všechny — jednotná hustota napříč měsíci.
// dotSize ≈ radiusPx × 0.8, detailDotSize ≈ radiusPx × 0.06.

const MOON_TICK = 10242; // icosphere level 5
...
export const MOONS = [
  { id: 'luna', name: 'LUNA', parent: 'earth',
    ...
    dotSize: 1.8, detailDotSize: 0.15 },
  ...
  { id: 'phobos', name: 'PHOBOS', parent: 'mars',
    ...
    dotSize: 0.6, detailDotSize: 0.04 },
  ...
  { id: 'europa', name: 'EUROPA', parent: 'jupiter',
    ...
    dotSize: 1.7, detailDotSize: 0.14 },
  { id: 'ganymede', name: 'GANYMEDE', parent: 'jupiter',
    ...
    dotSize: 2.2, detailDotSize: 0.22 },
  { id: 'callisto', name: 'CALLISTO', parent: 'jupiter',
    ...
    dotSize: 2.1, detailDotSize: 0.20 },
  ...
  { id: 'titan', name: 'TITAN', parent: 'saturn',
    ...
    dotSize: 2.2, detailDotSize: 0.21 },
  { id: 'rhea', name: 'RHEA', parent: 'saturn',
    ...
    dotSize: 1.0, detailDotSize: 0.07 },
  ...
  { id: 'dione', name: 'DIONE', parent: 'saturn',
    ...
    dotSize: 0.8, detailDotSize: 0.05 },

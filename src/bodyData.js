...
export const BODY_DATA = {
  ...
  ceres: {
    name: 'Ceres',
    kind: 'asteroid',
    tagline: 'Trpasličí planeta v hlavním asteroidovém pásu, nejmasivnější těleso pásu.',
    fields: [
      { label: 'Průměr', value: '940 km' },
      { label: 'Hmota', value: '~9,4×10²⁰ kg' },
      { label: 'Den', value: '9 hodin 4 minuty' },
      { label: 'Vzdálenost od Slunce', value: '414 mil. km (2,77 AU)' },
      { label: 'Atmosféra', value: 'velmi řídká vodní pára' },
      { label: 'Povrchová teplota', value: '−105 až −38 °C' },
      { label: 'Gravitace', value: '0,27 m/s²' },
      { label: 'Sluneční oběh', value: '4,6 roku' },
      { label: 'Objevitel', value: 'Giuseppe Piazzi, 1801' },
    ],
    funFact: 'Ceres byla první objevený asteroid (1801). Po 200 letech byla v 2006 přeřazena na trpasličí planetu — má dostatek hmoty pro hydrostatickou rovnováhu a kulový tvar. Sonda Dawn ji obíhala 2015–2018.',
  },

  vesta: {
    name: 'Vesta',
    kind: 'asteroid',
    tagline: 'Druhý největší asteroid, jeden z mála s diferencovaným nitrem.',
    fields: [
      { label: 'Průměr', value: '525 km (525×501×432 km)' },
      { label: 'Hmota', value: '~2,6×10²⁰ kg' },
      { label: 'Den', value: '5 hodin 20 minut' },
      { label: 'Vzdálenost od Slunce', value: '353 mil. km (2,36 AU)' },
      { label: 'Atmosféra', value: 'žádná' },
      { label: 'Povrchová teplota', value: '−190 až −20 °C' },
      { label: 'Gravitace', value: '0,22 m/s²' },
      { label: 'Sluneční oběh', value: '3,6 roku' },
      { label: 'Objevitel', value: 'Heinrich Olbers, 1807' },
    ],
    funFact: 'Vesta má diferencované nitro (jádro, plášť, kůra) jako planeta — proto se jí říká "proto-planeta". Velký impakt z její jižní polokoule odpadlé úlomky se nachází na Zemi jako HED meteority (5 % všech meteoritů!).',
  },

  pallas: {
    name: 'Pallas',
    kind: 'asteroid',
    tagline: 'Třetí největší asteroid s extrémně skloněnou orbitou.',
    fields: [
      { label: 'Průměr', value: '512 km' },
      { label: 'Hmota', value: '~2,1×10²⁰ kg' },
      { label: 'Den', value: '7 hodin 49 minut' },
      { label: 'Vzdálenost od Slunce', value: '415 mil. km (2,77 AU)' },
      { label: 'Atmosféra', value: 'žádná' },
      { label: 'Povrchová teplota', value: '−170 °C' },
      { label: 'Gravitace', value: '0,22 m/s²' },
      { label: 'Sluneční oběh', value: '4,6 roku' },
      { label: 'Sklon dráhy', value: '34,8°' },
      { label: 'Objevitel', value: 'Heinrich Olbers, 1802' },
    ],
    funFact: 'Pallas má enormní sklon dráhy 34,8° — orbituje skoro kolmo k ekliptice. Dlouho byla považována za zachycený objekt z Kuiperova pásu, ale recentní analýza naznačuje že se zformovala v současné poloze.',
  },
};
